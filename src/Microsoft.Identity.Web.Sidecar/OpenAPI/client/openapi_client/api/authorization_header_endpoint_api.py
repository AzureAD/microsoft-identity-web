...
class AuthorizationHeaderEndpointApi:
    ...
    def authorization_header(
        ...
        _param = self._authorization_header_serialize(
            api_name=api_name,
    ...
    @validate_call
    def authorization_header_with_http_info(
        self,
        api_name: StrictStr,
        agent_identity: Optional[StrictStr] = None,
        agent_username: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthorizationHeaderResult]:
        """Get an authorization header for a configured downstream API.
    ...
    @validate_call
    def authorization_header_without_preload_content(
        self,
        api_name: StrictStr,
        agent_identity: Optional[StrictStr] = None,
        agent_username: Optional[StrictStr] = None,
    ...
    def _authorization_header_serialize(
        self,
        api_name,
        agent_identity,
        agent_username,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/AuthorizationHeader/{apiName}',
    ...
    @validate_call
    def authorization_header_unauthenticated(
        self,
        api_name: StrictStr,
        agent_identity: Optional[StrictStr] = None,
        agent_username: Optional[StrictStr] = None,
        ...
        _param = self._authorization_header_unauthenticated_serialize(
            api_name=api_name,
            agent_identity=agent_identity,
            agent_username=agent_username,
            options_override_scopes=options_override_scopes,
    ...
    @validate_call
    def authorization_header_unauthenticated_with_http_info(
        self,
        api_name: StrictStr,
        agent_identity: Optional[StrictStr] = None,
        agent_username: Optional[StrictStr] = None,
    ...
    @validate_call
    def authorization_header_unauthenticated_without_preload_content(
        self,
        api_name: StrictStr,
        agent_identity: Optional[StrictStr] = None,
        agent_username: Optional[StrictStr] = None,
    ...
    def _authorization_header_unauthenticated_serialize(
        self,
        api_name,
        agent_identity,
        agent_username,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/AuthorizationHeaderUnauthenticated/{apiName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
