...
def downstream_api(api_name, agent_identity=None, agent_username=None, options_override_scopes=None, options_override_request_app_token=None, options_override_base_url=None, options_override_relative_path=None, options_override_http_method=None, options_override_accept_header=None, options_override_content_type=None, options_override_acquire_token_options_tenant=None, options_override_acquire_token_options_force_refresh=None, options_override_acquire_token_options_claims=None, options_override_acquire_token_options_correlation_id=None, options_override_acquire_token_options_long_running_web_api_session_key=None, options_override_acquire_token_options_fmi_path=None, options_override_acquire_token_options_pop_public_key=None, options_override_acquire_token_options_managed_identity_user_assigned_client_id=None):  # noqa: E501
    ...
    :rtype: Union[DownstreamApiResult, Tuple[DownstreamApiResult, int], Tuple[DownstreamApiResult, int, Dict[str, str]]
    """
...
def downstream_api_unauthenticated(api_name, agent_identity=None, agent_username=None, options_override_scopes=None, options_override_request_app_token=None, options_override_base_url=None, options_override_relative_path=None, options_override_http_method=None, options_override_accept_header=None, options_override_content_type=None, options_override_acquire_token_options_tenant=None, options_override_acquire_token_options_force_refresh=None, options_override_acquire_token_options_claims=None, options_override_acquire_token_options_correlation_id=None, options_override_acquire_token_options_long_running_web_api_session_key=None, options_override_acquire_token_options_fmi_path=None, options_override_acquire_token_options_pop_public_key=None, options_override_acquire_token_options_managed_identity_user_assigned_client_id=None):  # noqa: E501
