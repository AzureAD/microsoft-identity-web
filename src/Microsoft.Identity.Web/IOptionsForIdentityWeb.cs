...
{
    /// <summary>
    /// Interface for Microsoft Identity Web options, including ConfidentialClientApplicationOptions.
    /// </summary>
    internal interface IOptionsForIdentityWeb
    {
        /// <summary>
        ...
        /// Merge the options.
        /// </summary>
        /// <param name="microsoftIdentityOptions">MicrosoftIdentityOptions.</param>
        /// <param name="confidentialClientApplication">ConfidentialClientApplicationOptions.</param>
        /// <param name="microsoftIdentityOptionsFallback">Fallback.</param>
        /// <param name="confidentialClientApplicationFallback">Fallback .</param>
