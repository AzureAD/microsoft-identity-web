...
#pragma warning disable SA1124 // Do not use regions
        ...
        /// </param>
        /// <returns>The authentication builder for chaining.</returns>
        [Obsolete("Rather use AddMicrosoftIdentityWebApp(). See https://aka.ms/ms-id-web/0.3.0-preview")]
#pragma warning restore SA1124 // Do not use regions
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static MicrosoftIdentityWebAppAuthenticationBuilderWithConfiguration AddMicrosoftWebApp(
            this AuthenticationBuilder builder,
            IConfiguration configuration,
            string configSectionName = Constants.AzureAd,
            string openIdConnectScheme = OpenIdConnectDefaults.AuthenticationScheme,
            string cookieScheme = CookieAuthenticationDefaults.AuthenticationScheme,
            bool subscribeToOpenIdConnectMiddlewareDiagnosticsEvents = false) =>
                builder.AddMicrosoftIdentityWebApp(
                    configuration,
                    configSectionName,
                    openIdConnectScheme,
                    cookieScheme,
