            ...
            string? displayName)
        {
            ...
            builder.Services.AddOptions<OpenIdConnectOptions>(openIdConnectScheme)
                ...
                msIdOptions) =>
                {
                    ...
                    // populate msIdOptions for AccountController
                    msIdOptions.Value.SignUpPolicyId = mergedOptions.SignUpPolicyId;
                    msIdOptions.Value.SignInPolicyId = mergedOptions.SignInPolicyId;
                    msIdOptions.Value.SignUpSignInPolicyId = mergedOptions.SignUpSignInPolicyId;
                });
        }
