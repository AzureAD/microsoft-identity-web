...
namespace Microsoft.Identity.Web.Internal
{
    ...
    internal static class MicrosoftIdentityOptionsBinder
    {
        ...
        public static void Bind(MicrosoftIdentityOptions options, IConfigurationSection? configurationSection)
        {
            ...
            {
                var clientCredentials = new List<CredentialDescription>();
                clientCredentialsSection.Bind(clientCredentials);
            ...
            {
                var tokenDecryptionCredentials = new List<CredentialDescription>();
                tokenDecryptionCredentialsSection.Bind(tokenDecryptionCredentials);
