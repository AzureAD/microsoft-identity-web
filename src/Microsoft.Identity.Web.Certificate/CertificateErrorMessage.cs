...
namespace Microsoft.Identity.Web
{
    ...
    internal static class CertificateErrorMessage
    {
        ...
        public const string CustomProviderNameAlreadyExists =
            "IDW10111 The custom signed assertion provider '{ProviderName}' already exists, only the the first instance of ICustomSignedAssertionProvider in the provided IEnumerable will be used.";
        ...
        public const string CustomProviderNotFound = "IDW10113: The custom signed assertion provider with name '{ProviderName}' was not found. Was it registered in the service collection?";
