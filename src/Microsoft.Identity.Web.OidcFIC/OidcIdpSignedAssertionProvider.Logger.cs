...
namespace Microsoft.Identity.Web.OidcFic
{
    ...
    {
        /// <summary>
        /// Performant logging messages for OidcIdpSignedAssertionProvider.
        /// </summary>
        private static class Logger
        {
            ...
            public static void PostponingToFirstCall(ILogger logger) => s_postponingToFirstCall(logger, default!);
