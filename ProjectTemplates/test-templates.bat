REM Build and Install templates
...
REM Test Web app (Microsoft identity platform, Single Org)
mkdir webapp
cd webapp
...
REM Test Web app (Microsoft identity platform, Mutiple Orgs)
...
REM Test Web API  (Microsoft identity platform, SingleOrg)
mkdir webapi
cd webapi
