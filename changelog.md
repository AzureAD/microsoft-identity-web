...
==========
### Bug Fixes:
**Microsoft.IdentityModel.* version="6.9" introduced a breaking change in the mapping of the User.Identity.Name claim**. Microsoft Identity Web has a temporary workaround in place until a new Microsoft.IdentityModel version is released with a fix. See issues [#1136](https://github.com/AzureAD/microsoft-identity-web/issues/1136) and [#1140](https://github.com/AzureAD/microsoft-identity-web/issues/1140) for details.
