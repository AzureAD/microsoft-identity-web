...
namespace WebAppUiTests
{
    public static class UiTestHelpers
    {
        ...
        internal static bool StartAndVerifyProcessesAreRunning(List<ProcessStartOptions> processDataEntries, out Dictionary<string, Process> processes, uint numRetries)
        {
